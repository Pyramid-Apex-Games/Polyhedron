...
void ragdolldata::init(MovableEntity *d)
{
...
inline bool ragdolldata::collidevert(const vec &pos, const vec &dir, float radius)
{
    static MovableEntity v;
    v.o = pos;
